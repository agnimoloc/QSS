 ...
 * selections.
 */
public class ServiceListActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.service_detail_container) != null) {
			...
			((ServiceListFragment) getFragmentManager().findFragmentById(
					R.id.service_list)).setActivateOnItemClick(true);
		}
	}
	...
	public void onItemSelected(int id) {
		if (mTwoPane) {
			...
			arguments.putInt(ServiceDetailFragment.ARG_ITEM_ID, id);
